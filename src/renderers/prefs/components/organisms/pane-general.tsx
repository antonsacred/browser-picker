      ...
      <Row>
        ...
        <Right>
          {isDefaultProtocolClient ? (
            'browser-picker is the default web browser'
          ) : (
            <Button
          ...
          <p className="mt-2 text-sm opacity-70">
            Setting browser-picker as your default web browser means links
            clicked outside of web browsers will open the picker window. This is
            the primary design of browser-picker. However, you can also
            programmatically send URLs to browser-picker.
          </p>
        </Right>
      </Row>
      ...
      <Row>
        ...
        <Right>
          ...
          <p className="mt-2 text-sm opacity-70">
            ...
            added or removed a compatible app whilst browser-picker is running.
          </p>
        </Right>
      </Row>
